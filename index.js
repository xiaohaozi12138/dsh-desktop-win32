...
const DEFAULT_CONFIG = {
  ...
  // Absolute path to a custom .ico; empty = pop a file picker (or default asset).
  iconPath: "",
  // Pop a Windows file picker to choose the icon when no iconPath is set.
  askIconOnStart: true,
 ...
 * When asked (and no explicit/remembered icon), pops a native file picker.
 */
function resolveIcon(cfg, allowAsk) {
  ...
  if (allowAsk && cfg.askIconOnStart !== false) {
